...
async function readErrorResponseBody(response) {
	return require_misc.iife(async () => {
		try {
...
var AuthError = class AuthError extends ns.brand(GoogleError, "auth") {
	...
	*/
	...
	constructor(params) {
		...
		(0, _langchain_core_errors.stampRetryable)(this, isRetryableStatus(this.statusCode));
	}
	/**
...
var RequestError = class RequestError extends ns.brand(GoogleError, "request") {
	...
	*/
	...
	constructor(params) {
		...
		this.headers = params.headers;
		this.data = params.data;
		(0, _langchain_core_errors.stampRetryable)(this, this.isRetryable());
	}
	/**
